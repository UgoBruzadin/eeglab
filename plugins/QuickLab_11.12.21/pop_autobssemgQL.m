...
function [EEGOUT, com] = pop_autobssemgQL(EEG, wl, ws, bss_alg, bss_opt, crit_alg, crit_opt)
...
% -------------------
EEGIN.data = autobss(reshape(EEGIN.data,EEGIN.nbchan,EEGIN.pnts*EEGIN.trials),opt);
