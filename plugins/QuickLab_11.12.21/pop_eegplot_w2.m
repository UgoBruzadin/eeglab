...
if reject
    ...
    com1 = [ com1 ...
        ...
        'end; ' ];
    if icacomp == 1
        com3 = 'EEGTMP=EEG;EEG.chanrej = TMPREJ;[EEGTMP LASTCOM2] = eeg_eegrej2(EEGTMP,TMPREJ,1,0); ' ; %modified for eegrej2
    else
        com3 = 'EEGTMP=EEG;EEG.comprej = TMPREJ;[EEGTMP LASTCOM2] = eeg_eegrej2(EEGTMP,TMPREJ,2,0); ' ; %modified for eegrej2
    end;
...
%      
    com4 = [ ...
        ...
        'end;' ...
        'if ~isempty(LASTCOM2)' ... 'if or(~isempty(LASTCOM1),~isempty(LASTCOM2))' ... 
