...
if reject
    ...
    com1 = [ com1 ...
        ...
        'end; ' ];
    if icacomp == 1
        com3 = 'EEG.chanrej = TMPREJ;[EEGTMP LASTCOM2] = eeg_eegrej2(EEGTMP,TMPREJ,1,0); ' ; %modified for eegrej2
    else
        com3 = 'EEG.comprej = TMPREJ;[EEGTMP LASTCOM2] = eeg_eegrej2(EEGTMP,TMPREJ,2,0); ' ; %modified for eegrej2
    end;
