...
uimenu( channelmenu, 'label', 'Quick Reduce to 92/93 Channels (NIDA 5)', 'callback', ...
    ['[EEG,com] = quick_HM93(EEG);[ALLEEG EEG CURRENTSET] = eeg_store(ALLEEG, EEG, CURRENTSET);eeglab redraw;']);
% 
