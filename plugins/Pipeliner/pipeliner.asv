    ...
    methods(Static)
        ...
        function pipeIn(batchFolder,commands) %store the functions to be rolled in this batch
            ...
            for i=1:length(commands)
                if ~rem(i,2)
                    ...
                    pipeliner.Function(commands(1,i-1), cell2mat(commands(1,i)),batchFolder,folderCounter)
                end
            end
        end
        ...
        function Function(type,content,path,counter) %magic function, runs the code asked!
            ...
            parfor i=1:length(files)
                ...
                writecell(individualReport,strcat(files(i).name(1:end-4),acronym,'_report.xlsx')); %saves the table in .mat format
            ...
            for i=1:length(reports)
                ...
                writecell(finalReport, strcat(string(FolderName),'-','finalReport.xlsx'));
            end
            %sends text to me
