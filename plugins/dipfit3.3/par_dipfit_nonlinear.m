...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [EEGOUT] = par_dipfit_nonlinear( EEG, varargin )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% 
% dipfitA = EEG.dipfit.model(cfg.component).posxyz;
% dipfitB = EEG.dipfit.model(cfg.component).momxyz;
% dipfitC = EEG.dipfit.model(cfg.component).diffmap;
% dipfitD = EEG.dipfit.model(cfg.component).sourcepot;
% dipfitE = EEG.dipfit.model(cfg.component).datapot;
% dipfitF = EEG.dipfit.model(cfg.component).rv;
% dipfitG = EEG.dipfit.model(iComp).areadk;
