...
function [EEG,com] = test_speed(EEG,minfreq,maxfreq,type,df,newcommand)
...
tic
[EEG,com] = pop_viewprops2(EEG, 0, newcommand, 1:size(EEG.icawinv,2), {'freqrange',[minfreq maxfreq]})  ;
toc
EEG = eegh(com, EEG);
