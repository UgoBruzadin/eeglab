...
function [EEG,com] = pop_eegplot_adv_print( EEG, plotchannels, superpose, reject, isEpoched, topcommand, varargin)
...
%% --- run eegplot_adv!!
EEG = eegplot_adv_print( EEG, 'srate', EEG.srate, 'title', [ 'Advanced EEG Data Editor by Ugo Bruzadin Nunes -- eegplot_adv(): ' EEG.filename], ...
