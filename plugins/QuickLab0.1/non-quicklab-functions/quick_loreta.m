function [EEG,com] = quick_loreta(EEG,comps,dipoles)
...
% acronym  = 'DF'; 
[EEG,com] = pop_par_dipfit_settings( EEG, 'hdmfile','C:\\GitHub\\eeglab\\plugins\\dipfit3.7\\standard_BEM\\standard_vol.mat','coordformat','MNI','mrifile','C:\\GitHub\\eeglab\\plugins\\dipfit3.7\\standard_BEM\\standard_mri.mat','chanfile','C:\\GitHub\\eeglab\\plugins\\dipfit3.7\\standard_BEM\\elec\\standard_1005.elc','coord_transform',[0.05476 -17.3653 -8.1318 0.075502 0.0031836 -1.5696 11.7138 12.7933 12.213] ,'chansel',[1:EEG.nbchan] );
[EEG,com] = pop_multifit_loreta(EEG, comps ,'threshold',100,'plotopt',{'normlen','on'},'dipoles',dipoles);
