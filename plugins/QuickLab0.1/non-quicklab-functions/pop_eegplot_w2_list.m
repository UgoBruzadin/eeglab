...
%     
%     if reject
%         com_ = [ com1 com2 com3 'else LASTCOM1='''' ; end; ' com4 ];
%     else
%         com_ = [ com2 ...
...
eegplotoptions = { eegplotoptions{:} 'EEG' EEG };
...
%% --- run eegplot_w2!!
% if isEpoched ~= 3
    eegplot_w2( EEG.data(channels,:,:), 'srate', EEG.srate, 'title', [ title 'QuickLab Data Editor! -- eegplot_w2(): ' EEG.setname], ...
