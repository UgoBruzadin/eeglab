function EEG = cudafastN1PCA(EEG)
...
if ~isempty(EEG.icawinv)
    ...
    EEG = pop_runica(EEG,'icatype','cudaica','extended', 1,'pca',IC-1,'verbose','off');
...
%     end
    ...
    try
        EEG = pop_runica(EEG,'icatype','cudaica','extended', 1, 'verbose','off');
