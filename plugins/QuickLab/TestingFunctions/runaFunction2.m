function [outparam2] = runaFunction2(EEG)

[outparam,b,c,d] = inputgui('geometry', { [1 1] [0.5 2] [1 1] }, ...
'geomvert', [1 3 1], 'uilist', { ...
{'style' 'pushbutton' 'string' 'Select Set File(s) ' 'callback' '[files,path] = uigetfile(''*.set'',''Select One or More Files'',''MultiSelect'', ''on'');'} { 'Style', 'edit', 'string', '' 'tag' 'files'}...
